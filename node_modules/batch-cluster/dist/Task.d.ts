...
import { Parser } from "batch-cluster/dist/Parser";
export type TaskOptions = Pick<InternalBatchProcessOptions, "streamFlushMillis" | "observer" | "passRE" | "failRE" | "logger">;
/**
 ...
 * result of the task.
 */
export declare class Task<T = unknown> {
    #private;
