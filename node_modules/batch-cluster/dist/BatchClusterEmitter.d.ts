import { Args } from "batch-cluster/dist/Args";
import { BatchProcess } from "batch-cluster/dist/BatchProcess";
import { Task } from "batch-cluster/dist/Task";
import { WhyNotHealthy } from "batch-cluster/dist/WhyNotHealthy";
...
export interface BatchClusterEvents {
     ...
     * stream.
     */
    taskData: (data: Buffer | string, task: Task<unknown> | undefined, proc: BatchProcess) => void;
    /**
     ...
     */
    taskTimeout: (timeoutMs: number, task: Task<unknown>, proc: BatchProcess) => void;
    /**
